...
export class Query extends $Base<"Query"> {
  ...
  cardById<Args extends VariabledInput<{
      ...
      }>,Sel extends Selection<Card>>(args: Args, selectorFn: (s: Card) => [...Sel]):$Field<"cardById", JoinFields<Sel> | undefined, "Query" , ExtractVariables<Sel, Args>> {
      const options = {
        argTypes: {
              cardId: "string | undefined"
            },
...
drawCard<Sel extends Selection<Card>>(selectorFn: (s: Card) => [...Sel]):$Field<"drawCard", JoinFields<Sel>, "Query" > {
      const options = {
...
drawChangeCard<Sel extends Selection<ChangeCard>>(selectorFn: (s: ChangeCard) => [...Sel]):$Field<"drawChangeCard", JoinFields<Sel>, "Query" > {
      const options = {
...
listCards<Sel extends Selection<Card>>(selectorFn: (s: Card) => [...Sel]):$Field<"listCards", Array<JoinFields<Sel>>, "Query" > {
      const options = {
...
myStacks<Sel extends Selection<CardStack>>(selectorFn: (s: CardStack) => [...Sel]):$Field<"myStacks", Array<JoinFields<Sel>> | undefined, "Query" > {
      const options = {
...
nameables<Sel extends Selection<Nameable>>(selectorFn: (s: Nameable) => [...Sel]):$Field<"nameables", Array<JoinFields<Sel>>, "Query" > {
      const options = {
...
export class CardStack extends $Base<"CardStack"> {
  ...
  cards<Sel extends Selection<Card>>(selectorFn: (s: Card) => [...Sel]):$Field<"cards", Array<JoinFields<Sel>> | undefined, "CardStack" > {
      const options = {
...
export class ChangeCard extends $Union<{SpecialCard: SpecialCard,EffectCard: EffectCard}, "ChangeCard"> {
  constructor() {
...
attack<Args extends VariabledInput<{
        cardID: Array<string>,
      }>,Sel extends Selection<Card>>(args: Args, selectorFn: (s: Card) => [...Sel]):$Field<"attack", Array<JoinFields<Sel>> | undefined, "Card" , ExtractVariables<Sel, Args>> {
      const options = {
        argTypes: {
              cardID: "Array<string>"
            },
...
cardImage<Sel extends Selection<S3Object>>(selectorFn: (s: S3Object) => [...Sel]):$Field<"cardImage", JoinFields<Sel> | undefined, "Card" > {
      const options = {
...
export class Mutation extends $Base<"Mutation"> {
  ...
  addCard<Args extends VariabledInput<{
        card: createCard,
      }>,Sel extends Selection<Card>>(args: Args, selectorFn: (s: Card) => [...Sel]):$Field<"addCard", JoinFields<Sel>, "Mutation" , ExtractVariables<Sel, Args>> {
      const options = {
        argTypes: {
              card: "createCard"
            },
...
export class Subscription extends $Base<"Subscription"> {
  ...
  deck<Sel extends Selection<Card>>(selectorFn: (s: Card) => [...Sel]):$Field<"deck", Array<JoinFields<Sel>> | undefined, "Subscription" > {
      const options = {
...
thing<Sel extends Selection<Number>>(selectorFn: (s: Number) => [...Sel]):$Field<"thing", JoinFields<Sel>, "EffectCard" > {
      const options = {
